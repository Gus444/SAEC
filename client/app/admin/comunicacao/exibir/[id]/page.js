            ...
            <table className="table table-bordered mt-4">
                <tbody>
                    <tr>
                        ...
                        <td>{docs?.comDocsId || "ID do Documento"}</td>
                    </tr>
                    <tr>
                        <th>Documento</th>
                        <td>
                        <a 
                            href={`${COMUNICACAO_IMG_CAMINHO}${docs?.comDocsNome}`} 
                            download={docs?.comDocsNome} // Define o nome do arquivo a ser baixado
                            style={{ textDecoration: 'none' }} // Remover sublinhado do link
                            >
                                <img 
                                    src={`${COMUNICACAO_IMG_CAMINHO}${docs?.comDocsNome}`} 
                                    alt="Documento" 
                    ...
                    <tr>
                        ...
                        <td>{docs?.comunicacaoId || "ID da Comunicação"}</td>
                    </tr>
                </tbody>
            </table>
        </div>
